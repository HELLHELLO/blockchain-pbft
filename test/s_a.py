...
chain_client=Client(node_list=a_list, client_config=client_config, client_id=2, node_sum=4,timeout=20, test=True)
a = Server(config={"ip": "127.0.0.1", "port": "56666"},test=False,chain_client=chain_client)
a.start()